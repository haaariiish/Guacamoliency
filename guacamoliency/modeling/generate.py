...
def main():
    ...
    parser.add_argument('--mscaffolds', type = str, default = "False",
                        help="is it a conversational model for mscaffolds predicting", required=False)
    ...
    if args.mscaffolds == "True" or args.mscaffolds == "true" or args.mscaffolds == "1":
        mscaffolds = True
    else:
        mscaffolds = False
