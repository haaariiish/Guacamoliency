...
for c in 20600 41200 61800 82400 103000 123600 144200 164800 185400 206000
do
python guacamoliency/modeling/generate.py \
    --model moses_ClearSMILES_corrected \
    --model_dir "models/trained_moses_ClearSMILES_corrected_weightedLoss_character_level/2/checkpoint-$c" \
    --num_sequence 10000 \
    --temperature 1 \
    --output_dir "data/generated/moses_ClearSMILES_corrected_CL_2_checkpoint_$c.csv"
