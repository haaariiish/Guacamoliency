python guacamoliency/generate_character_based_tokenizer.py --input_dir data/data_tokenizer/moses_ClearSMILES.csv --input moses_ClearSMILES --model_max_length 61
