python guacamoliency/saliency_scoring.py \
    ...
    --output_dir 'reports/data/moses_canonical_CL/1'\
    --threshold 0
...
python guacamoliency/saliency_scoring.py \
    ...
    --output_dir 'reports/data/moses_ClearSMILES_CL/1'\
    --threshold 0
...
python guacamoliency/saliency_scoring.py \
    ...
    --model_dir 'models/trained_guacamol_canonical_character_level/1/final_model' \
    --dataset 'data/generated/guacamol_canonical_CL_1.csv' \
    --output_dir 'reports/data/guacamol_canonical_CL/1'\
    --threshold 1
...
python guacamoliency/saliency_scoring.py \
    ...
    --dataset 'data/generated/moses_ClearSMILES_CL_5_1.csv' \
    --output_dir 'reports/data/moses_ClearSMILES_CL/5'\
    --threshold 1

python guacamoliency/saliency_scoring.py \
    --model moses_canonical_CL \
    --model_dir 'models/trained_moses_canonical_character_level/5/final_model' \
    --dataset 'data/generated/moses_canonical_CL_5_21.csv' \
    --output_dir 'reports/data/moses_canonical_CL/5'\
    --threshold 1
