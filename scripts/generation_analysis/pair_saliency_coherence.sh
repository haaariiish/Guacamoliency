python guacamoliency/saliency_pair_coherence.py \
    ...
    --dataset 'data/generated/moses_canonical_CL_5.csv' \
    --output_dir 'reports/data/moses_canonical_CL/5/pair_coherence_data.csv'\
    --threshold 1
...
python guacamoliency/saliency_pair_coherence.py \
    ...
    --output_dir 'reports/data/moses_ClearSMILES_CL/5/pair_coherence_data.csv'\
    --threshold 1
