...
python guacamoliency/modeling/generate.py \
    --model moses_ClearSMILES \
    --model_dir 'models/trained_moses_ClearSMILES_character_level/2/final_model' \
    --num_sequence 10000 \
    --temperature 1 \
    --output_dir "data/generated/moses_ClearSMILES_CL_2.csv"
...
python guacamoliency/modeling/generate.py \
        --model moses_canonical \
        --model_dir 'models/trained_moses_canonical_character_level/2/final_model' \
        --num_sequence 10000 \
        --temperature 1 \
        --output_dir "data/generated/moses_canonical_CL_2.csv"

python guacamoliency/modeling/generate.py \
        --model moses_canonical \
        --model_dir 'models/trained_moses_canonical_character_level/3/final_model' \
        --num_sequence 10000 \
        --temperature 1 \
        --output_dir "data/generated/moses_canonical_CL_3.csv"